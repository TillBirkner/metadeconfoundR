...
```{r runPartialPlotting, eval=TRUE, echo=FALSE, message=FALSE, fig.width = 4.5, fig.height=5, fig.cap="Figure 7: BuildHeatmap() plotting of partial effect sizes calculated by GetPartialEfSizes()"}
